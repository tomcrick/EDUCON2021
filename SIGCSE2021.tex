...
\title[The International Impact of COVID-19 on CS Education]{The
  Impact of COVID-19 on the International\\Computer Science Education Community}
...
settings, from K-12 through to universities. This paper looks
...
perceptions, curriculum, pedagogy, assessment, computer science
education}
...
Whlle there has been a rapid shift to digital learning during the
...
recent evidence assessments on remote learning~\cite{eefremote:2020},
...
levels. This directly links to recent major international changes to computer
science curricula, qualifications and practice (e.g. in the
...
We thus undertook an anonymous survey of internation computer
...
determine whether there are significant differences between those
...
sciences there was also significant differences between education
...
subject specialist in computer sciences ``{\emph{ICT coordinator my
...
computer sciences as a discipline, but also about improvements in
...
raised in response to the resource needed to study computer sciences
...
teaching computer science ``{\emph{There's something lost if I can't
interact with my students in a classroom setting. Assessment takes a
real dive.}}'' [USA], this lack of face-to-face interaction was a key
concern for school practitioners ``{\emph{now that there is no
...
computer sciences are the best equipped to deal with these changes
...
that some Universities may close}}'' [UK] summarise practitioners
concerns about the fragility of the HE sector as a whole within this
climate. For computer sciences in particular, respondents raised
...
[UK]. Furthermore, concerns were raised about how effectively certain
...
``{\emph{research will be the hard part}}'' [UK]; ``{\emph{this has
...
of computer science online is difficult.}}'' [Wales]
\end{quotation}
...
teaching and learning of mathematics and computer science.}}'' [England]
\end{quotation}
...
was collected. However, this research offers some insight into
...
students\footnote{Also see: ``{\emph{Academic lives are in
transition}}''
...
(April 2020)}. It is also important to acknowledge the ongoing media
...
to the wider IT industry and UK digital economy focus, it is clear
there will be a huge demand for digital skills and
infrastructure~\cite{tryfonas+crick:petra2018,davenport-et-al:educon2020}.
to support the global post-COVID economic
renewal~\cite{nadellaft:2020}.
...
Finally, recent evidence from the UK suggests that young people are more
...
from this rapid response survey of international computer science
practitioners, we anticipate continued evaluation and development of
best practice for online LT\&A as we move into the 2020-2021 academic
year and beyond, especially as it appears that the virus may have to
