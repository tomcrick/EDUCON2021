...
other disciplines. However, while practitioners noted the
opportunities of these changes for their respective sector --
especially a renewed focus on the importance of digital pedagogies and
practice -- they raised a number of wider concerns on the impact of
this shift to online on their roles, their institutions and their
sectors as a whole; for example, the impact on workload and job
...
technical topics such as programming, AI/robotics and mathematical
foundations, as well as the impact on various types of formal
examinations and assessment. Based on the data obtained from this
rapid response international survey, we offer informed commentary on
emerging learning and teaching strategies that will likely continue to
be constrained by coronavirus into 2021 and possibly beyond.
\end{abstract}
